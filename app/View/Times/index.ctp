<div class="times index">
	...
	<tr>
		...
		<td><?php echo h($time['Time']['start']); ?>&nbsp;</td>
		<td><?php echo h($time['Time']['end']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $time['Time']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $time['Time']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
