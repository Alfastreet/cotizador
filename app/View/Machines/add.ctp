...
<?php echo $this->Form->create('Machine'); ?>
	<fieldset>
	<?php
	echo "<h3>Datos de la máquina</h3>";
		echo "Serial";
		echo $this->Form->input('serial', array('style'=>'width:400px;', 'label' => ''));
		echo "<br>";
		
	    echo "Modelo";
		echo $this->Form->input('model', array('style'=>'width:400px;', 'label' => ''));
		echo "<br>";
		
		echo "Fecha de fabricación";
		echo $this->Form->input('fabricate', array('style'=>'width:400px;', 'label' => ''));
		echo "<br>";
		...
		echo "Año";
		echo $this->Form->input('year', array('style'=>'width:400px;', 'label' => ''));
		echo "<br>";
		
				echo "Tamaño del monitor";
		echo $this->Form->input('monitor', array('style'=>'width:400px;', 'label' => ''));
		echo "<br>";
