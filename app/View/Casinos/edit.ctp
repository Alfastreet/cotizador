      ...
      <nav class="navbar navbar-expand-md navbar-dark  bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item ">
              <a class="nav-link" href="http://localhost/casinos/add">Añadir<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/casinos">Listar</a>
            </li>
...
<?php echo $this->Form->create('Casino'); ?>
	...
	<?php
		...
		echo "<b>Autorización de pagos y servicios</b><br>";
...
<?php echo $this->Form->end(__('Editar Casino')); ?>
</div>
